...
export const calendarPatternPage: Page = {
  ...
  blocks: [
    ...
    },
    {
      ...
      id: 'ex-el-1-3',
      number: '예제 1.3.1',
      problem: '어떤 달의 12일이 금요일이면 19일은 무슨 요일인지 구하시오.',
      hint: '12일에서 19일은 7일 차이이다.',
      solution:
        '**풀이.** 19일은 12일보다 정확히 7일 뒤이다. 7일이 지나면 같은 요일이 반복되므로 19일도 **금요일**이다.',
  ...
  exercises: [
    {
      id: 'exr-el-1-3',
      number: '연습문제 1.3.1',
      problem: '8일이 화요일이면 22일은 무슨 요일인지 구하시오.',
      hints: [
        '22일은 8일보다 14일 뒤이다.',
        '14일은 7일이 두 번이므로 같은 요일이다.',
      ],
      solution: '**풀이.** 14일 차이는 7일의 두 배이므로 요일이 같다. 따라서 22일은 **화요일**이다.',
      visualize: [{ kind: 'calendarPattern', day: 8, interactive: false }],
    },
    {
      id: 'exr-el-1-3-2',
      number: '연습문제 1.3.2',
      problem: '5일이 월요일이면 26일은 무슨 요일인지 구하시오.',
      hints: [
        '26일은 5일보다 21일 뒤이다.',
        '21일은 7일이 세 번이므로 같은 요일이다.',
      ],
      solution:
        '**풀이.** 21일은 7일의 세 배이므로 요일이 변하지 않는다. 따라서 26일은 **월요일**이다.',
      visualize: [{ kind: 'calendarPattern', day: 5, interactive: false }],
    },
    {
      id: 'exr-el-1-3-3',
      number: '연습문제 1.3.3',
      problem: '11일이 수요일이면 18일과 25일은 각각 무슨 요일인지 구하시오.',
      hints: [
        '18일은 11일보다 7일 뒤이다.',
        '25일은 18일보다 다시 7일 뒤이다.',
      ],
      solution:
        '**풀이.** 7일이 지나면 같은 요일이 반복된다. 따라서 18일도 수요일이고, 25일도 다시 **수요일**이다.',
