...
export const distanceTimePage: Page = {
  ...
  blocks: [
    ...
    },
    {
      ...
      id: 'ex-el-1-4',
      number: '예제 1.4.1',
      problem: '자동차가 시속 50km로 3시간 동안 일정하게 달렸어요. 이동 거리를 구해 보세요.',
      hint: '거리 = 속력 × 시간',
      solution:
        '**풀이.** 거리 = 속력 × 시간이므로 $50 \\times 3 = 150$이에요. 따라서 이동 거리는 **150km**예요.',
  ...
  exercises: [
    {
      id: 'exr-el-1-4',
      number: '연습문제 1.4.1',
      problem: '시속 60km로 2시간 이동하면 몇 km를 가는지 구해 보세요.',
      hints: [
        '거리 = 속력 × 시간',
        '$60 \\times 2$를 계산한다.',
      ],
      solution: '**풀이.** $60 \\times 2 = 120$이므로 **120km** 이동해요.',
      visualize: [{ kind: 'distanceTime', speed: 60, sampleTime: 2, interactive: false }],
    },
    {
      id: 'exr-el-1-4-2',
      number: '연습문제 1.4.2',
      problem: '자전거가 시속 15km로 4시간 동안 일정하게 달렸어요. 이동 거리를 구해 보세요.',
      hints: [
        '거리 = 속력 × 시간',
        '$15 \\times 4$를 계산한다.',
      ],
      solution: '**풀이.** $15 \\times 4 = 60$이므로 **60km** 이동해요.',
      visualize: [{ kind: 'distanceTime', speed: 15, sampleTime: 4, interactive: false }],
    },
    {
      id: 'exr-el-1-4-3',
      number: '연습문제 1.4.3',
      problem: 'A 자동차는 시속 40km, B 자동차는 시속 70km로 각각 3시간 동안 달렸어요. 어느 자동차가 더 멀리 갔는지, 또 몇 km 더 갔는지 구해 보세요.',
      hints: [
      ...
      solution:
        '**풀이.** A 자동차는 $40 \\times 3 = 120$km, B 자동차는 $70 \\times 3 = 210$km 이동해요. 따라서 **B 자동차가 90km 더 멀리** 갔어요.',
      visualize: [
